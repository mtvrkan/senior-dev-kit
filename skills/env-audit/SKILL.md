---
name: env-audit
description: Audit environment variables across the codebase. Finds missing declarations, leaked defaults, unused vars, and inconsistencies between .env.example and actual usage.
