...
// Entry-point guard (same pattern as routing-eval.ts's extractRoutedAgent):
// importing this module for its pure functions must not trigger a live scan
// of this machine's real transcript history.
