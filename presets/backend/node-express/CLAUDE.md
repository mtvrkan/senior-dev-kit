...
// RIGHT — wrap async routes (or use express-async-errors / Fastify handles this natively)
import "express-async-errors"  // once at entry point — all async errors caught by global handler
