...
- Add indexes based on real query patterns; use `EXPLAIN (ANALYZE, BUFFERS)` to confirm the planner actually uses the new index before considering the migration done.
